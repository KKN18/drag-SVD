...
#---------------Option----------------#
inversion_strength = 0.35 # TODO: 0.7 / max: 0.35
inference_step = 50 # TODO: 50
guidance_scale = 1.0
lr = 0.01
...
output_dir_path = f"/home/nas2_userG/junhahyung/kkn/drag-SVD/output/numframes_{num_frames}_npixstep_{n_pix_step}_inversionstrength_{inversion_strength}"
