...
target_dir_path = "/home/nas2_userG/junhahyung/kkn/drag-SVD/simple_pixels"
output_dir_path = "/home/nas2_userG/junhahyung/kkn/drag-SVD/output"
inversion_strength = 0.2 # TODO: 0.7
inference_step = 25 # TODO: 50
guidance_scale = 1.0
lr = 0.01
lam = 0.1 # regularization strength on unmasked areas
n_pix_step = 80 # number of gradient descent
num_frames = 2
#-------------------------------------#
...
latents = torch.load(f"{latent_dir_path}/latents.pt")
...
updated_init_code = torch.load(f"/home/nas2_userG/junhahyung/kkn/drag-SVD/updated_init_code.pt")
