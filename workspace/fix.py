...
destination_dir = '/home/nas2_userG/junhahyung/kkn/drag-SVD/fixed_pixels/'
...
for i in range(1, 8):
    ...
    # pixel[2] = pixel[0], pixel[3] = pixel[1] 적용
    modified_pixels = pixels.copy()
    modified_pixels[:, 2] = pixels[:, 0]  # pixel[2]을 pixel[0]과 동일하게 설정
    modified_pixels[:, 3] = pixels[:, 1]  # pixel[3]을 pixel[1]과 동일하게 설정
