...
class MyUnet(UNetSpatioTemporalConditionModel):
    ...
    def predict(
        ...
        time_proj: torch.nn.Module = None,
        time_embedding: torch.nn.Module = None,
        add_time_proj: torch.nn.Module = None,
        add_embedding: torch.nn.Module = None,
        conv_in = None,
        down_blocks = None,
        mid_block = None,
        up_blocks = None,
        ...
        # 6. post-process
        sample = conv_norm_out(sample)
        sample = conv_act(sample)
